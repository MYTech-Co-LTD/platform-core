...
- `deploy/` — 部署面：只两份 compose（主 + 数据面，见 `deploy/README.md`）、宿主 Dockerfile、
  两份 runbook（`openship-adopt.md` 待人工执行；`branch-protection-runbook.md` 记录分支保护的现状与替代机制，见 `deploy/README.md`）
